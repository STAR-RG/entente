...
class ECMAScriptUnlexer(Grammarinator):
    ...
    def DoubleStringCharacter(self):
        ...
        choice = self.choice([0 if [0, 1, 2][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1, 1])])
        if choice == 0:
    ...
    def EscapeSequence(self):
        ...
        choice = self.choice([0 if [2, 0, 2, 2][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1, 1, 1])])
        if choice == 0:
    ...
    def EscapeCharacter(self):
        ...
        choice = self.choice([0 if [1, 1, 0][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1, 1])])
        if choice == 0:
            current += self.unlexer.SingleEscapeCharacter()
        elif choice == 1:
            current += self.unlexer.DecimalDigit()
    ...
    def IdentifierPart(self):
        ...
        choice = self.choice([0 if [1, 1, 1, 1, 1, 1][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1, 1, 1, 1, 1])])
        if choice == 0:
            current += self.unlexer.IdentifierStart()
        elif choice == 1:
    ...
    def RegularExpressionFirstChar(self):
        ...
        choice = self.choice([0 if [0, 2, 1][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1, 1])])
        if choice == 0:
    ...
    def RegularExpressionClassChar(self):
        ...
        choice = self.choice([0 if [0, 2][i] > self.unlexer.max_depth else w for i, w in enumerate([1, 1])])
        if choice == 0:
