% citacoes exemplo
% Sugestões de uso das citações:
% \cite{bruno:2015}
% \cite[p.1]{bruno:2015}
% \cite[p.1-5, p.7]{bruno:2015}
% \citeonline{bruno:2015}
% \citeauthoronline{bruno:2015}
% \citeauthor{bruno:2015}
% \citeyear{bruno:2015}
\newcommand{\repoJSC}{https://github.com/WebKit/webkit/tree/master/JSTests/es6}
\newcommand{\repoVeight}{https://github.com/v8/v8}
\newcommand{\repoSM}{https://github.com/mozilla/gecko-dev/tree/master/js/src/tests/non262}
\newcommand{\repoCH}{https://github.com/Microsoft/ChakraCore}
\newcommand{\repoEcma}{https://github.com/tc39/test262}

\newcommand{\repoJerry}{https://github.com/jerryscript-project/jerryscript}
\newcommand{\repoJSI}{https://github.com/technosaurus/jsish}
\newcommand{\repoDuktape}{https://github.com/svaarala/duktape}
\newcommand{\repoTinyJS}{https://github.com/gfwilliams/tiny-js}
%% helpers
\newcommand{\js}{JS}
