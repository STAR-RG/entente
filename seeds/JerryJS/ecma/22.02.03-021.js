...
if(!(float64[0] === 10.1 && float64[1] === 11.2 && float64[2] === 12.3)) throw new Error("Test failed");

float64.set([13.1, 14.2, 15.3], 1);
if(!(float64[0] === 10.1 && float64[1] === 13.1 && float64[2] === 14.2 && float64[3] === 15.3)) throw new Error("Test failed");
