...
function test_set_prototype_of_error(o, proto, msg)
{
  ...
  if(!(name === "TypeError")) throw new Error("Test failed");

}

function test_set_prototype_of_success_set(o, proto, msg)
{
  if(!(o === Object.setPrototypeOf(o, proto))) throw new Error("Test failed");
  if(!(proto === Object.getPrototypeOf(o))) throw new Error("Test failed");
