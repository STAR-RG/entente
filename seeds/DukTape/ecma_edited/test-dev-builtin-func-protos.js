...
*/
    ...
    if((Object.getPrototypeOf(f1) === Function.prototype) !== true) throw new Error('Test Failed')
    if((Object.getPrototypeOf(f2) === Function.prototype) !== true) throw new Error('Test Failed')
    if((Object.getPrototypeOf(f3) === Function.prototype) !== true) throw new Error('Test Failed')
    if((Object.getPrototypeOf(f4) === Function.prototype) !== true) throw new Error('Test Failed')
}
