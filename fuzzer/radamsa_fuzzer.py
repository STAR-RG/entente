...
#     # TODO: move this opening to fuzz_dir level
#     with open(os.path.join(constants.logs_dir, ntpath.basename(file_path)+"all.log"), "w") as generallog_file_object:
#         generallog_file_object.write(file_path + "\n")

#         fuzz_file(10)

#         # TODO: we have similar code in test_es6. try to unify
