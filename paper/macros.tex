...
\newcommand{\nofuzzAll}{\Fix{232}}
\newcommand{\nofuzzHighTotal}{\Fix{137}}
\newcommand{\nofuzzLowTotal}{\Fix{95}}

\newcommand{\nofuzzMozilla}{62}
\newcommand{\nofuzzWebKit}{9}
\newcommand{\nofuzzJerry}{12}
\newcommand{\nofuzzGoogleDuktap}{1} % 1 and 1
\newcommand{\nofuzzTC}{147}
\newcommand{\nofuzzTinyAndJSI}{none}

% continue updating bugs table
\newcommand{\tableBugsNum}{\Fix{24}}
\newcommand{\nofuzzHighReport}{\Fix{10}}
\newcommand{\nofuzzLowReport}{\Fix{1}}