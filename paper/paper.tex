...
identifier we assigned to the bug\Comment{, column ``Date'' shows the
  date the bug was reported in the format ``m/dd'',}, column
...
%%  LocalWords:  JavascriptCore Url radamsa TinyJS \jerry{} JSC crr
%%  LocalWords:  quickfuzz \jsc{} \chakra{}'s valueOf NUL ascii crrrr
%%  LocalWords:  unary ToNumber NaN testcase WebKit typeof foofoofoo
%%  LocalWords:  SSL TLS ICSE ReferenceError TypeError lineNumber
%%  LocalWords:  drainMicrotasks subtrees ArrayBuffer RangeError eval
%%  LocalWords:  ToIndex Clusterization DataView setInt getInt boxpos
%%  LocalWords:  JavaScriptCore SpiderMonkey byteOffset anonymized
%%  LocalWords:  xleftmargin framexleftmargin basicstyle numberstyle
%%  LocalWords:  escapeinside morekeywords
