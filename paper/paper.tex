...
\subsection{Expected Inconsistencies}
...
\Igor{
  ...
  com priority HI e \nofuzzingLow{} do grupo LO. Nos analisamos cuidadosamente
  cada warning reportado pela ferramenta, a fim de encontrar bugs reais nos engenhos
  javascript. Nosso estudo revelou que dos \nofuzzingHigh{} do grupo HI, 
...
%  \scriptsize
  ...
  \begin{tabular}{cccccccc}
    ...
    \midrule
    23 & 7/12 & \crossmark & Chakra & Dup (\#10) & \href{https://github.com/Microsoft/ChakraCore/issues/5453}{\#5453} & HI & JerryScript\\
    24 & 7/17 & \crossmark & SpiderMonkey & New & \href{https://bugzilla.mozilla.org/show_bug.cgi?id=1476321}{\#1476321} & HI & JerryScript\\
   \bottomrule
  \end{tabular}
\end{table*}
