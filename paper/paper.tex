...
of failure. 
\Fix{It is worth noting that we also did not include the tests
...
$\leftarrow$\Breno{Haven't we decided that Hermes should be removed from Table 3? 
If yes, maybe this explanation will only create confusing.}
\Mar{Not sure if I understood the conclusion. Do you mean the total amount of test
...
%\Igor{yes, it is. Some Node internal features are 
%not included in the JS engine, including some keywords (ie. require, module).
%In addiction, a project with nodejs require a package.json with a lot of external dependencies.} 
...
those fuzzers implement a traversal of the production rules of the
