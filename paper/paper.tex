...
%  \vspace{-2ex}
  ...
  \subfloat[\label{fig:stacked-engine}Bug reports per engine.]{
    \includegraphics[trim=0 190 0 180,clip,width=\textwidth,scale=0.4]{R/stackedbar/stacked-engine}
    \vspace{-5ex}
  }\\
...
\begin{table}[t]
  ...
  \begin{tabular}{ccrrrr}
    ...
    \chakra & \cite{chakracore}\\
    \hermes & \cite{hermes2020repo}\\
    \midrule
    ...
    Hermes & \cite{jsi} & \hermesOriginal{} & \hermesPassInPar{} & \hermesCompileAll{} & \hermesNoFailAll{}\\
    \midrule
