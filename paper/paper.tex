...
high impact. For example, in October 2014 a new attribute added to
Array objects caused a bug in the MS Outlook Calendar web app under
...
challenging as specifications are incomplete and evolve
frequently. Consequently, it is often non-trivial to assess if a test
fails because of a bug or because of some other reason. For example, a
test may fail because the engine does not fully implement some
feature. The publicly-available Kangax compatibility
table~\cite{kangax} highlights this problem--it relates features of
\js\ with the engines that support them. As another example of a
failure that is not caused by a bug, a test that passes in one engine
could legitimately fail in another engines because of some undefined
behavior in the spec\footnote{These cases of undefined behavior can be
  ...
  in the ES6 spec document~\cite{ecmas262-spec}.}.
...
the effectiveness of two complementary diversity-aware techniques to
find bugs in \js\ engines. \emph{Test transplantation} leverages
...
\begin{itemize}
  ...
  \item \textbf{Timeout/OME\footnote{ome is for out of memory
    ...
    %%   passes without failures. Another case can be found in JerryScript suite
  ...
  \item \textbf{Unknown.} This category corresponds to the cases we
    were unable to confidently diagnose the failure.  \Igor{ We
      observed that some tests are not valid due not corresponds to
      the ES6 specifications, we skip these warnings.  }\Mar{Igor,
      this is not well-formed english and I don't understand what you
      want to say.}
...
\Igor{
  JSC Severity doc \url{https://webkit.org/bug-prioritization/}
  Chakra usa label para definir prioridades, porem neste doc nao ha explicacao das severidades
  \url{https://github.com/Microsoft/ChakraCore/wiki/Label-Glossary}. Contudo, se clicar nessas 
  labels vai direcionar para as issues e la pode-se ver a severidade de cada.
  V8 guidelines \url{https://www.chromium.org/for-testers/bug-reporting-guidelines/chromium-bug-labels}
}
...
%  \scriptsize
  ...
  \begin{tabular}{cccccccc}
    ...
    \midrule    
    1  & 4/18  & JavascriptCore  & New  & \anonym{\href{https://bugs.webkit.org/show\_bug.cgi?id=184749}{\#184749}} & - & JerryScript      \\
   2  & 4/23 & Chakra  & \textbf{Confirmed}  & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5033}{\#5033}} & 2 & \smonkey{}      \\
   3  & 4/29 & Chakra  & \textbf{Confirmed}   &
    \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5065}{\#5065}} & 2 & \smonkey{} \\
   \midrule
    \multirow{2}{*}{4}  & \multirow{2}{*}{4/29} & Chakra & \textbf{Confirmed} &    \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5067}{\#5067}} & 2 & \multirow{2}{*}{\smonkey{}}\\
                       &  &
   ...
   6 & 5/17  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5187}{\#5187}} & 2 & \jsc{}\\
   7 & 5/21  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5203}{\#5203}} & 2 & \smonkey{}\\
   8 & 6/28  & Chakra & \textbf{Confirmed}  & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5388}{\#5388}} & 2 & \jsc{}\\
   9 & 7/10  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5442}{\#5442}} & 2 & JerryScript\\
   10 & 7/18  & Chakra & \textbf{Fixed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5478}{\#5478}} & 2 & \smonkey{}\\
   11 & 7/18  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=187777}{\#187777}} & - & JerryScript\\
   12 & 8/07  & Chakra & New & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5576}{\#5576}} & - & JerryScript\\
   13 & 8/07  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188378}{\#188378}} & - & JerryScript\\
   14 & 8/07  & Chakra & New & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5579}{\#5579}} & - & JerryScript\\
   15 & 8/07  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188382}{\#188382}} & - & JerryScript\\
   16 & 8/08  & V8 & \textbf{Confirmed} & \anonym{\href{https://bugs.chromium.org/p/v8/issues/detail?id=8033}{\#8033}} & 3 & JerryScript\\
   17 & 8/08  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188407}{\#188407}} & - & JerryScript\\
   \bottomrule
  \end{tabular}
\end{table*}
