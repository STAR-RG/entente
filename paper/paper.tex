...
\begin{itemize}
  \item \textbf{Undefined Behavior.} False positives of this kind are
    ...
    \chakra\ for that test. \Igor{ Several tests explores 
    the error message from a function violation, due the error
    message string is distinct and the type of Error is equal,
    we considered these cases as undefined behavior too.
    }
  ...
  \item \textbf{Timeout/OME\footnote{ome is for out of memory
    ...
    out of memory.\Comment{For example, we found that only \jsc{} implements
    tail-call optimization to avoid tail recursion.}
    \Igor{
  ...
  \item \textbf{Not implemented.} False positives of this kind
    ...
    implement various properties from the \mcodeid{Symbol} object, 
    \Igor{these implementation are in experimental mode 
    (ie. activating with flag -ES6Experimental)}.

  \item \textbf{Unknown.} This source corresponds to the cases we were
    unable to confidently diagnose the failure.
    \Igor{
      We observed that some tests are not valid due
      not corresponds to the ES6 specifications,
      we skip these warnings.
    }
...
\Igor{
  To generate our priority between engines we classified our bugs confirmed 
  based on the priority that the devs of the bug trackers that we explore. 
  We defined 3 levels of priority called P1, P2 and P3. P1 is related to
  the engine cores that involves crashes and parsers errors. P2 is related
  to ES spec conformance and P3 refer to bugs related to bugs in general, for example
  invalid message outputs, Automatic Semicolon Insertion(ASI) and compatibility issues.
}
...
%  \scriptsize
  ...
  \begin{tabular}{cccccccc}
    ...
    \midrule    
    1  & 4/18  & JavascriptCore  & New  & \anonym{\href{https://bugs.webkit.org/show\_bug.cgi?id=184749}{\#184749}} & \Fix{x} & JerryScript      \\
   2  & 4/23 & Chakra  & \textbf{Confirmed}  & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5033}{\#5033}} & \Fix{x} & Mozilla      \\
   3  & 4/29 & Chakra  & \textbf{Confirmed}   &
    \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5065}{\#5065}} & \Fix{x} & Mozilla \\
   \multirow{2}{*}{4}  & \multirow{2}{*}{4/29} & Chakra & \textbf{Confirmed} &    \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5067}{\#5067}} & \multirow{2}{*}{\Fix{x}} & \multirow{2}{*}{Mozilla}\\
                       &  &
    JavascriptCore & New &    \anonym{\href{https://bugs.webkit.org/show\_bug.cgi?id=185130}{\#185130} } &   & \\
   5 & 5/02  & JavascriptCore & New  & \anonym{\href{https://bugs.webkit.org/show\_bug.cgi?id=185208}{\#185208}} & \Fix{x} & Mozilla \\
   6 & 5/17  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5187}{\#5187}} & \Fix{x} & \jsc{}\\
   7 & 5/21  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5203}{\#5203}} & \Fix{x} & Mozilla\\
   8 & 6/28  & Chakra & \textbf{Confirmed}  & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5388}{\#5388}} & \Fix{x} & \jsc{}\\
   9 & 7/10  & Chakra & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5442}{\#5442}} & \Fix{x} & JerryScript\\
   10 & 7/18  & Chakra & \textbf{Fixed} & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5478}{\#5478}} & \Fix{x} & Mozilla\\
   11 & 7/18  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=187777}{\#187777}} & \Fix{x} & JerryScript\\
   12 & 8/07  & Chakra & New & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5576}{\#5576}} & \Fix{x} & JerryScript\\
   13 & 8/07  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188378}{\#188378}} & \Fix{x} & JerryScript\\
   14 & 8/07  & Chakra & New & \anonym{\href{https://github.com/Microsoft/ChakraCore/issues/5579}{\#5579}} & \Fix{x} & JerryScript\\
   15 & 8/07  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188382}{\#188382}} & \Fix{x} & JerryScript\\
   16 & 8/08  & V8 & New & \anonym{\href{https://bugs.chromium.org/p/v8/issues/detail?id=8033}{\#8033}} & \Fix{x} & JerryScript\\
   15 & 8/08  & JavascriptCore & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188407}{\#188407}} & \Fix{x} & JerryScript\\
   \bottomrule
  \end{tabular}
\end{table*}
