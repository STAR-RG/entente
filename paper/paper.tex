...
\author[ufpe]{Igor Lima}
\ead{isol2@cin.ufpe.br}
\author[ufpe]{Breno Miranda}
\ead{bafm@cin.ufpe.br}
\author[ufpe]{Marcelo d'Amorim}
\ead{damorim@cin.ufpe.br}
\address[ufpe]{Universidade Federal de Pernambuco, Recife, PE, Brazil}
...
ordering that status labels are assigned. Note that several of these
...
for diversity-aware testing. The scripts to run the experiments will
be available upon request. The data is publicly available \dataRepo{}.
...
\begin{wraptable}[8]{r}{0.22\textwidth}
  \vspace{-4ex}
  \centering
...
\begin{wraptable}[11]{r}{0.23\textwidth}
  \vspace{-4ex}
  \small
  \centering
...
\vspace{1ex}
\noindent\textbf{Acknowledgments.~}Igor was supported by the FACEPE
fellowship \Fix{...}  This research was partially funded by INES 2.0,
FACEPE grants PRONEX APQ 0388-1.03/14 and APQ-0399-1.03/17, and CNPq
grant 465614/2014-0.
