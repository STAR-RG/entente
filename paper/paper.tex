...
in a few hours.  This is a test case original from the \hermes suite
using test transplantation.  According the specification, in strict
mode, the engine must use the prefix '0o' or '0O' to represents octal
numeric literals. It was an issue which explores a deprecated octal
token after ASI (Automatic Semicolon Insertion).  The others engine
throws a SyntaxError due the missing of the octal token, but \smonkey
returns a integer 8 that represents 010 in octal.
