...
\Mar{REVISE}The goal of our study is to assess reliability of \js\ engines by
...
\label{sec:stability}
\Igor{
  Marcelo, de acordo com os resultados obtidos, prefiro retirar
  esse paragrafo e tabela, nao houve perda/aumento de falhas nesses
  ultimos 7 dias, acho que valeria a pena se fizessemos isso 1 vez por semana
  durante os ultimos meses.
}
\Mar{REVISE}We evaluated stability with Test262~\cite{ecma262-conformance-suite},
