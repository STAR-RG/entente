...
mutations like \radamsa. In contrast to \radamsa, \quickfuzz\ is aware
...
\label{sec:methodology}
In this experiment we analyzed each failure observed in a test
execution. A developer with experience in \js\ analyzed each files in
separate and classified the failure as potentially fault-revealing or
not (\ie{}, a false positive). The co-authors supervised the
classification process as to validate correctness. For the cases the
...
(or re-classified the failure as a false alarm).
...
\CodeIn{-ES6Experimental}. \Mar{revise this.}\textbf{Unknown.} This
...
slice label naming the source of false positive.  We observed that
``Unknown'' and ``Undefined'' were the most predominant
...
%  \scriptsize
  ...
  \begin{tabular}{cccccccc}
   ...
   6 & 5/02  & \jsc{} & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=185211}{\#185211}} & - & \smonkey{}\\
   7 & 5/17  & \chakra{} & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5187}{\#5187}} & 2 & \jsc{}\\
   8 & 5/21  & \chakra{} & \textbf{Fixed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5203}{\#5203}} & 2 & \smonkey{}\\
   9 & 6/28  & \chakra{} & \textbf{Confirmed}  & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5388}{\#5388}} & 2 & \jsc{}\\
   10 & 7/10  & \chakra{} & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5442}{\#5442}} & 2 & \jerry{}\\
   11 & 7/18  & \chakra{} & \textbf{Fixed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5478}{\#5478}} & 2 & \smonkey{}\\
   12 & 7/18  & \jsc{} & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=187777}{\#187777}} & - & \jerry{}\\
   13 & 7/18  & \chakra{} & \textbf{Fixed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5549}{\#5549}} & 2 & \jerry{}\\
   14 & 8/07  & \chakra{} & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5576}{\#5576}} & 3 & \jerry{}\\
   15 & 8/07  & \jsc{} & \textbf{Fixed} & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188378}{\#188378}} & 2 & \jerry{}\\
   16 & 8/07  & \chakra{} & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5579}{\#5579}} & 3 & \jerry{}\\
   17 & 8/07  & \jsc{} & \textbf{Fixed} & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188382}{\#188382}} & 2 & \jerry{}\\
   18 & 8/08  & \veight{} & \textbf{Fixed} & \anonym{\href{https://bugs.chromium.org/p/v8/issues/detail?id=8033}{\#8033}} & 3 & \jerry{}\\
   19 & 8/08  & \jsc{} & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188407}{\#188407}} & - & \jerry{}\\
   20 & 8/16  & \veight{} & WontFix & \anonym{\href{https://bugs.chromium.org/p/v8/issues/detail?id=8064}{\#8064}} & 2 & Duktape\\
   21 & 8/22  & \chakra{} & \textbf{Confirmed} & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5621}{\#5621}} & 2 & \smonkey{}\\
   22 & 8/22  & \jsc{} & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188874}{\#188874}} & - & \smonkey{}\\   
   \midrule
    \multirow{3}{*}{23}  & 
   ...
   \midrule
   24 & 8/22  & \jsc{} & New & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188877}{\#188877}} & - & \smonkey{}\\
   \bottomrule
  \end{tabular}
\end{table}
...
''Fixed''), column ``Url'' shows the web address for the bug report
entry in the bug tracking system (de-anonymized upon request), column
...
\jsc{} uses five levels~\cite{jsc-severity} whereas
...
sensitive to function specifications. \Igor{devemos remover isso da 
