...
In this case, the plus operator turns into a flag of the RegExp \CodeIn{+/v/},
but this flag is not valid. The behavior expected is throws an early
SyntaxError due to a invalid regular expression flag,
but \hermes\ seems not treats the early validation of the regexp flags
