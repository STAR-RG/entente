...
report is pending confirmation.\Mar{por favor,
  corrija estes numeros *com cuidado*! se possivel, use macros.}\Igor{Done} Of
the \noBugsTransplantation{} bugs we reported in this experiment, \noTransConfirmed{} were
...
highest number, \noTransChakraBugs{} in total, with \noTransChakraBugsFixed{} 
bug fixed. Considering the remaining engines, \veight{} 
developers confirmed \noTransVeightBugsConfirmed{} of the
\noTransVeightBugsReported{} bug we reported, fixing \noTransVeightBugsFixed{}. 
Curiously, Google engineers confirmed the report we issued in a few hours. We found that
...
returns a string representation of a null character (\CodeIn{NUL} in
