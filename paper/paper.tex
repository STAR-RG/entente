...
fail in an assertion instead. \Mar{igor, ha alguma explicacao/intuicao
  ...
  seja mais especifico, por favor!}  \textbf{Unknown.} This category
...
Esse bug foi reportado no engenho do \chakra{} e foi manifestado atraves 
de uma mutacao provinda do \radamsa{}. O test case eh descrito in Figure~\ref{xxx},
the 
