...
These techniques demand different effort from developers. Cross-engine
differential testing is semi-automated as developers need to decide if
alarms are manifestations of real bugs. Test transplantation is fully
automated, but it can only reveal bugs that the original tests could
reveal. This study measures the ability of these techniques in finding
bugs and the human cost associated with each technique.
