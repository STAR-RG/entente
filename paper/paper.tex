...
\begin{table}[t]
  ...
  \begin{tabular}{ccrc}
    \toprule
    Name & Source & \# JS files & \# JS files final \\
    \midrule
    TC-39 (Test262) & \cite{ecma262-conformance-suite} & 31,276 & 29,846\\
    \midrule
    \jsc{} & \cite{webkit} & 1,031 & 1,021 \\
    \smonkey\ & \cite{mozilla} & 2,634 & 2,116 \\
    \veight{} & \cite{v8} & 75 & 57 \\
    \midrule    
    Duktape & \cite{duktape} & 1,195 & 921\\ 
    \jerry{} & \cite{jerryscript} & 1,951 & 1,878\\
    JSI & \cite{jsi} & 99 & 63 \\
    Tiny-js & \cite{tinyjs} & 49 & 37 \\    
    % \chakra{} & \cite{chakracore} & 2632 \\
    \midrule
     &  & \totalTestFiles{} & \totalTestFilesFilter{} \\
   \bottomrule     
  \end{tabular}
\end{table}
