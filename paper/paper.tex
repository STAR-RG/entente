...
\begin{table}[t]
  ...
  \begin{tabular}{ccrrrr}
    ...
    BlogEngine.NET & \cite{blogEngineNet2020repo} & \blogEngineNetOriginal{} & \blogEngineNetPassInPar{} & \blogEngineNetCompileAll{} & \blogEngineNetNoFailAll{} \\
    \midrule
...
\lbrack{}Dedup\rbrack{}~\Fix{Explain what we did to avoid
  dups. Consider moving to the the sentence ``Finally, note that the number of tests in V8''}
...
\Fix{...add and discuss histograms}
...
\begin{figure}[t]
  ...
  \caption{\label{fig:workflow}Differential Testing infrastructure
    overview.\Fix{tem certeza que Hermes estah usando mesma fonte/tamanho?}}
\end{figure}
