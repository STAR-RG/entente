...
This section discusses a selection of bugs. The selection criteria we
used was: (i) to cover each of the engines we were able to find
bugs--\chakra, \jsc, and \veight, and (ii) to cover a different
technique--test transplantation and differential testing (with
\radamsa\ and with \quickfuzz).
