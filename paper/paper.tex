...
\begin{center}
  \fbox{
    \begin{minipage}{8cm}
      ...
      effective at finding several bugs in \js\ engines. However,
      relative to test transplantation, it required substantial more
      human effort, which may play a lesser role with improved
      automation.
      \end{minipage}
    }
\end{center}
