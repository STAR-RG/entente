...
\totalTestFilesCompileInAll{} cases. \Mar{can you confirm that we used
  ...
  (\ie, (7029*4)-1021-57-2116).}  Of these, 812 failures were observed
(3.25\% of the runs) across \textbf{543} distinct files (7.72\% of the
files). We analyzed each of these files in separate as to classify if
the failure was fault-revealing or a false positive.
...
not clear clustering criteria to use for that. Note that \Fix{...}
