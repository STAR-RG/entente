...
%  \scriptsize
  ...
  \begin{tabular}{cccccccc}
   ...
   13 & 8/07  & JavascriptCore & \textbf{Fixed} & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188378}{\#188378}} & 2 & \jerry{}\\
   14 & 8/07  & \chakra{} & New & \anonym{\href{https://github.com/Microsoft/\chakra{}Core/issues/5579}{\#5579}} & - & \jerry{}\\
   15 & 8/07  & JavascriptCore & \textbf{Fixed} & \anonym{\href{https://bugs.webkit.org/show_bug.cgi?id=188382}{\#188382}} & 2 & \jerry{}\\
...
Several fuzzing techniques have been proposed recently\Fix{...elaborate...}
...
has been made. Yang and
colleagues~\cite{Yang:2011:FUB:1993498.1993532} have proposed CSmith
to randomly create C programs from a grammar, for a subset of C, and
then check the output of these programs in different compilers (\eg{},
GCC and LLVM). Le and colleagues~\cite{Le:2014:CVV:2594291.2594334}
proposed the idea of ``equivalence modulo inputs'', which creates
variants of program which should have equivalent behavior compared to
the original, but for which the compiler manifests
...
across engines. Patra and Pradel evaluated their fuzzing strategy on
different browsers~\cite{patra2016learning} (see
Section~\ref{sec:testing-js-engines}).
