...
code already.\Comment{ Depending on the issue date, the fix may be in
  the latest release of the corresponding engines.} Overall, ignoring
...
%%  LocalWords:  jsfunfuzz jit funfuzz \smonkey{} toPrecision JSVU os
...
%%  LocalWords:  SSL TLS ICSE ReferenceError TypeError lineNumber sep
...
%%  LocalWords:  escapeinside morekeywords cccrr ccrrrr Duktape JSI
%%  LocalWords:  Lembrar que
