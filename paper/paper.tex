...
bugs (\noBugsTransplantationConfirmed{} confirmed, \noBugsTransplantationFixed{} fixed) and differential
testing revealed \noBugsDifferentialTesting{} bugs
(\noBugsDifferentialTestingConfirmed{} confirmed and \noBugsDifferentialTestingFixed{} fixed). Furthermore, results indicate
...
\begin{itemize}
  \item The diversity-aware techniques we used in this study are great
  ...
  \item Mozilla's \smonkey\ appears to be the most reliable
    \js\ engine, with Google's \veight\ after it;
